  ...
  const oferta = normalizarOfertaManualV2(
    {
      ...
      precoPix: primeiroTexto(dados.precoPix),
      precoMin: primeiroTexto(dados.precoMin),
      precoMax: primeiroTexto(dados.precoMax),
      temVariacaoPreco: dados.temVariacaoPreco === true || Boolean(texto(dados.precoMin) && texto(dados.precoMax)),
