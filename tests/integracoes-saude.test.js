...
assert.strictEqual(ml.estado, "saudavel");
...
assert.strictEqual(ml.estado, "atencao");
...
assert.strictEqual(amazon.estado, "saudavel");
...
assert.strictEqual(amazon.estado, "atencao");
...
assert.strictEqual(registro.estado, "pendente", "salvar config nao deve gerar verde");
...
assert.strictEqual(registro.estado, "atencao");
...
assert.strictEqual(registro.estado, "pendente", "credencial alterada após sucesso volta para pendente");
...
assert.strictEqual(antigo.estado, "pendente", "config antiga sem registro oficial deve aparecer pendente");
