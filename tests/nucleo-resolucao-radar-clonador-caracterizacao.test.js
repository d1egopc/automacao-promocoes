...
const fixtures = [
  ...
  { nome: "Amazon direto com ASIN", marketplace: "amazon", links: [URLs.amazonDireto], esperados: { radar: [URLs.amazonDireto], clone: [URLs.amazonDireto], papeis: ["produto"] } },
  { nome: "Amazon amzn.to", marketplace: "amazon", links: [URLs.amzn], esperados: { radar: [produtoAmazon("B0C3T4MFMM")], clone: [produtoAmazon("B0C3T4MFMM")], papeis: ["produto"], redirectsRadar: 1 } },
  { nome: "Amazon amzn.divulgador.link", marketplace: "amazon", links: [URLs.divulgador], esperados: { radar: [produtoAmazon("B0D4T5MFNN")], clone: [produtoAmazon("B0D4T5MFNN")], papeis: ["produto"], redirectsRadar: 1 } },
  { nome: "Amazon amzlink.to", marketplace: "amazon", links: [URLs.amzlink], esperados: { radar: [produtoAmazon("B0E5T6MFPP")], clone: [produtoAmazon("B0E5T6MFPP")], papeis: ["produto"], redirectsRadar: 1 } },
